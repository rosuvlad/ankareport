const data = {
  ...
  departments: [
    ...
    },
    {
      ...
      code: "RND-2025",
      projects: [
        { name: "Next Gen Prototype", budget: 1200000, spent: 900000, status: "in_progress", completion: 75 },
        { name: "Patent Filing", budget: 150000, spent: 145000, status: "completed", completion: 100 },
      ],
    },
    {
      ...
      code: "SUP-2025",
      projects: [
        { name: "Ticketing System Upgrade", budget: 80000, spent: 75000, status: "completed", completion: 100 },
      ],
    },
    {
      name: "Legal",
    ...
    },
    {
      ...
      code: "FIN-2025",
      projects: [
        { name: "Audit Prep", budget: 50000, spent: 48000, status: "completed", completion: 100 },
      ],
    },
    {
      ...
      code: "PM-2025",
      projects: [
        { name: "Roadmap 2026", budget: 20000, spent: 15000, status: "in_progress", completion: 40 },
      ],
    },
    {
      ...
      code: "QA-2025",
      projects: [
        { name: "Automated Testing Suite", budget: 300000, spent: 250000, status: "in_progress", completion: 80 },
      ],
    },
    {
      name: "Logistics",
      manager: "Frank Martin",
      revenue: 0,
      expenses: 2800000,
      profit: -2800000,
      employeeCount: 55,
      ...
      code: "LOG-2025",
      projects: [
        { name: "Warehouse Optimization", budget: 500000, spent: 480000, status: "completed", completion: 100 },
      ],
    },
    {
      name: "Procurement",
    ...
    },
    {
      ...
      code: "SEC-2025",
      projects: [
        { name: "Zero Trust Implementation", budget: 900000, spent: 400000, status: "in_progress", completion: 45 },
      ],
    },
    {
      name: "Facilities",
      manager: "Janitor Scrubs",
      revenue: 0,
      expenses: 400000,
      profit: -400000,
      employeeCount: 8,
      ...
      code: "FAC-2025",
      projects: [
        { name: "Office Renovation", budget: 150000, spent: 150000, status: "completed", completion: 100 },
      ],
    },
  ],
